...
pipeline_link = urlopen(r'https://github.com/abc1298000/my_repo/raw/eed8bcf0268ee7d2f6c9de87efe317bf8c5eccb6/pipeline.pkl')
...
data_pipeline = pickle.load(pipeline_link)
anvil.server.connect("PP42TTVZEX62NILKT6KDXY7V-HKRG3TAK27TE7KUD")
